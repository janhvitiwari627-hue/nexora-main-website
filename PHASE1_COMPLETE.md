...
- Created `supabase/APPLY_LIVE_DB_GUIDE.md` – order to apply 10 migrations via Dashboard SQL Editor, with verification queries
...
- Migrations in order:
  ...
  10. 20260806_growth_partner_identity – server-generated Growth Partner identity and referral code
