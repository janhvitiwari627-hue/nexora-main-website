import { Calendar, Users, ClipboardList, Search, CheckCircle2, AlertCircle, X, ChevronRight, Clock, Phone, DollarSign, TrendingUp, MessageSquare, Download } from 'lucide-react';
...
export default function PaymentsTab() {
  const { totalBookingsValue, totalAdvanceCollected, totalRemainingAtSalon, appointments, setAppointments, setNotifications, paymentsFilter, setPaymentsFilter, paymentsSearch, setPaymentsSearch, selectedPaymentId, setSelectedPaymentId } = useDashboard();
  return (
              <motion.div 
                key="payments"
