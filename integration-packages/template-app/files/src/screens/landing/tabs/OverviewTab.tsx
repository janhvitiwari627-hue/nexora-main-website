import { Sparkles, Copy, Calendar, Users, Scissors, Plus, Trash2, Monitor, Clock, Laptop, DollarSign, TrendingUp, Trophy, Heart, Play, Video } from 'lucide-react';
...
export default function OverviewTab() {
  const { setActiveTab, data, goToStep, onOpenStaffManagement, platform, liveUrl, chrome, dashboardWeeklyTop, totalBookingsValue, totalAdvanceCollected, totalRemainingAtSalon, activeServicesCount, staffTeamCount, todayActiveBookings, copied, handleCopyLink, appointments, handleUpdateApptStatus, handleDeleteAppt, setShowNewAppointmentModal, handleToggleStaffStatus, setEditingService, setShowServiceDrawer, setNewServiceName, setNewServiceCategory, setNewServicePrice, setNewServiceDuration, setNewServiceDesc, setNewServiceFeatured } = useDashboard();
  return (
              <motion.div 
                key="overview"
